...
class Raid1 extends PositionComponent {
    ...
    Future<void> _loadExplosionAnimation() async {
      final explosionImage = await Flame.images.load('explosion-transparent.png');
      final explosionSpriteSheet = SpriteSheet(image: explosionImage, srcSize: Vector2(128, 128));
      final explosionAni = explosionSpriteSheet.createAnimation(row: 0, stepTime: 0.2);
